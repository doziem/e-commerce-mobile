        ...
        <>
            <SafeAreaView style={{ paddingTop: Platform.OS === "android" ? 40 : 0, flex: 1, backgroundColor: '#fff' }}>
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                        {list.map((item, index) => (
                            <Pressable key={index} style={{ margin: 10, justifyContent: 'center', alignItems: 'center' }}>
                                <Image source={{ uri: item?.image }} style={{ width: 60, aspectRatio: 1 }} resizeMode='contain' />
                                <Text style={{ textAlign: 'center', fontSize: 13, fontWeight: 'semibold', marginTop: 5 }}>{item?.name}</Text>
                            </Pressable>
                        ))}
                    </ScrollView>
                    <SliderBox
                    ...
                    />
                    <Text style={{ fontSize: 18, fontWeight: 'bold', padding: 10 }}>Trending Deals of the week</Text>
                    <View style={{ flexDirection: 'row', alignItems: 'center', flexWrap: 'wrap' }}>
                        {deals.map((item, i) => (
                            ...
                            >
                                <Image source={{ uri: item?.image }} style={{ width: 180, aspectRatio: 1, }} resizeMode='contain' />
                            </Pressable>
                        ))}
                    </View>
            ...
            >
                <ModalContent style={{ width: '100%', height: 400 }}>
                    <View style={{ marginBottom: 8 }}>
                        <Text style={{ fontSize: 16, fontWeight: 'semibold' }}>Choose Your Location</Text>
                        <Text style={{ fontSize: 16, marginTop: 5, color: 'gray' }}>Select a delivery location to see product availabilty and delivery
                            options</Text>
                    </View>
                    <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                    ...
                    <View style={{ flexDirection: 'column', gap: 7, marginBottom: 30 }}>
                        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 5 }}>
                            <Entypo name='location-pin' size={24} color='#0066bc' />
